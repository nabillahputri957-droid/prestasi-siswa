...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-5 border-b border-gray-50 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('admin.prestasi.create')); ?>" class="bg-blue-200 hover:bg-blue-300 text-gray px-4 py-2 rounded-lg text-sm font-medium transition-colors shadow-sm">
