...
<?php $__env->startSection('header_title', 'Master Data Kelas'); ?>
<?php $__env->startSection('header_subtitle', 'Kelola daftar kelas sekolah'); ?>

<?php $__env->startSection('content'); ?>
<div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-5 border-b border-gray-50 flex justify-between items-center">
        <h3 class="text-gray-800 font-medium">Daftar Kelas</h3>
        <button onclick="openModal('modal-tambah')" class="bg-blue-200 hover:bg-blue-300 text-gray px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2 shadow-sm">
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-gray-100 text-sm">
                ...
                <tr class="hover:bg-gray-50/50 transition-colors">
                    <td class="px-6 py-4 text-gray-500"><?php echo e($kelas->firstItem() + $index); ?></td>
                    <td class="px-6 py-4 font-medium text-gray-800"><?php echo e($item->nama_kelas); ?></td>
                    <td class="px-6 py-4 text-center">
                        <div class="flex items-center justify-center gap-3">
                            <button onclick="openEditModal(<?php echo e($item->id); ?>, '<?php echo e($item->nama_kelas); ?>')" class="text-blue-500 hover:text-blue-700 transition-colors" title="Edit">
                                <i class="fa-regular fa-pen-to-square text-lg"></i>
                            </button>

                            <form action="<?php echo e(route('admin.kelas.destroy', $item->id)); ?>" method="POST" class="delete-form inline-block">
                                <?php echo csrf_field(); ?>
    ...
    <div class="p-5 border-t border-gray-50"><?php echo e($kelas->links()); ?></div>
</div>
    ...
    <div class="bg-white rounded-xl shadow-xl w-full max-w-md p-6 transform scale-95 transition-transform duration-300" id="modal-tambah-content">
        ...
        <form action="<?php echo e(route('admin.kelas.store')); ?>" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="nama_kelas" placeholder="Contoh: 1" required class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none text-sm transition-all">
            </div>
            <div class="flex justify-end gap-3 mt-6">
                ...
                <button type="submit" class="px-6 py-2 bg-blue-200 hover:bg-blue-300 text-gray rounded-lg text-sm font-medium transition-colors shadow-sm focus:ring-4 focus:ring-blue-100">Simpan Data</button>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\prestasi-siswa\resources\views/admin/kelas/index.blade.php ENDPATH**/ ?>