<?php $__env->startSection('title', 'Modul Prestasi'); ?>
<?php $__env->startSection('header_title', 'Modul Prestasi'); ?>
<?php $__env->startSection('header_subtitle', 'Manajemen Kategori dan Tingkat Lomba'); ?>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100 text-xs">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        <td class="px-4 py-3 text-gray-500"><?php echo e($kategori->firstItem() + $index); ?></td>
                        <td class="px-4 py-3 font-medium text-gray-800"><?php echo e($item->jenis_prestasi); ?></td>
                        <td class="px-4 py-3 text-gray-600"><?php echo e($item->nama_kategori); ?></td>
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-2">
                                <button onclick="openEditModalKategori(<?php echo e($item->id); ?>, '<?php echo e($item->nama_kategori); ?>', '<?php echo e($item->jenis_prestasi); ?>')" class="text-blue-500 hover:text-blue-700 transition-colors">
                                    <i class="fa-regular fa-pen-to-square text-sm"></i>
                                </button>
                                <form action="<?php echo e(route('admin.kategori.destroy', $item->id)); ?>" method="POST" class="delete-form inline-block">
        ...
        <div class="p-3 border-t border-gray-50 text-xs"><?php echo e($kategori->appends(request()->except('kategori_page'))->links()); ?></div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
        ...
        <div class="overflow-x-auto flex-1">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100 text-xs">
                    <?php $__empty_1 = true; $__currentLoopData = $tingkat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        <td class="px-4 py-3 text-gray-500"><?php echo e($tingkat->firstItem() + $index); ?></td>
                        <td class="px-4 py-3 font-medium text-gray-800"><?php echo e($item->nama_tingkat); ?></td>
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-2">
                                <button onclick="openEditModalTingkat(<?php echo e($item->id); ?>, '<?php echo e($item->nama_tingkat); ?>')" class="text-blue-500 hover:text-blue-700 transition-colors">
                                    <i class="fa-regular fa-pen-to-square text-sm"></i>
                                </button>
                                <form action="<?php echo e(route('admin.tingkat.destroy', $item->id)); ?>" method="POST" class="delete-form inline-block">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                    <button type="button" class="text-red-500 hover:text-red-700 transition-colors btn-delete"><i class="fa-regular fa-trash-can text-sm"></i></button>
                                </form>
                            </div>
        ...
        <div class="p-3 border-t border-gray-50 text-xs"><?php echo e($tingkat->appends(request()->except('tingkat_page'))->links()); ?></div>
    </div>
...
<div id="modal-tambah-tingkat" class="fixed inset-0 z-50 hidden bg-gray-900/10 backdrop-blur-md flex items-center justify-center transition-opacity">
    <div class="bg-white rounded-xl shadow-xl w-full max-w-md p-6 transform scale-95 transition-transform duration-300" id="modal-tambah-tingkat-content">
        ...
        <form action="<?php echo e(route('admin.tingkat.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-5">
...
<script>
    ...
    <?php if($errors->any()): ?> Swal.fire({ icon: 'error', title: 'Validasi Gagal', text: '<?php echo e($errors->first()); ?>', confirmButtonColor: '#3b82f6' }); <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\prestasi-siswa\resources\views/admin/modul_prestasi/index.blade.php ENDPATH**/ ?>