            ...
            <div class="w-full lg:w-1/4">
                <div class="sticky top-28">
                    ...
                    <div class="flex flex-col space-y-1.5">
                        <a href="<?php echo e(route('home')); ?>#timeline" class="px-4 py-3 rounded-xl text-sm font-semibold transition-all <?php echo e(!request('tahun_ajaran_id') ? 'bg-primary text-white shadow-md shadow-blue-500/20' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'); ?>">
                            Semua Tahun
                        </a>
                        <?php $__currentLoopData = $tahunAjaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('home', ['tahun_ajaran_id' => $ta->id])); ?>#timeline" class="px-4 py-3 rounded-xl text-sm font-semibold transition-all <?php echo e(request('tahun_ajaran_id') == $ta->id ? 'bg-primary text-white shadow-md shadow-blue-500/20' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'); ?>">
                                <?php echo e($ta->tahun); ?>
            ...
            <div class="w-full lg:w-3/4 relative">
                ...
                <div class="space-y-8 relative z-10">
                    ...
                    <div class="relative flex items-start group">
                        ...
                        <div class="flex flex-col items-center sm:items-end w-20 sm:w-24 flex-shrink-0 pt-5 pr-4 sm:pr-8 relative">
                            ...
                            <span class="text-xs font-medium text-slate-400 mb-0.5"><?php echo e($item->tanggal->translatedFormat('M')); ?></span>
                            <span class="text-sm font-bold text-slate-700"><?php echo e($item->tanggal->format('Y')); ?></span>
                        </div>
                            ...
                            <div class="flex flex-col sm:flex-row gap-5">
                                ...
                                <div>
                                    <div class="flex gap-2 mb-2">
                                        <span class="text-[10px] font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-md"><?php echo e($item->kategori->jenis_prestasi); ?> (<?php echo e($item->kategori->nama_kategori); ?>)</span>
                                        <span class="text-[10px] font-bold text-yellow-700 bg-yellow-100 px-2 py-0.5 rounded-md"><?php echo e($item->tingkat->nama_tingkat); ?></span>
                                    </div>
                                    <h4 class="text-lg font-bold text-slate-900 mb-1 leading-tight group-hover:text-primary transition-colors"><?php echo e($item->nama_lomba); ?></h4>
                                    <p class="text-sm text-slate-700 font-medium mb-3"><?php echo e($item->siswa->nama); ?> <span class="text-slate-400 font-normal ml-1">&bull; Kelas <?php echo e($item->siswa->kelas->nama_kelas ?? 'Alumni'); ?></span></p>
                                    <p class="text-sm text-slate-500 leading-relaxed"><?php echo e($item->deskripsi); ?></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-12 sm:pl-32 flex flex-col items-start gap-8">
                    <?php if($prestasi->hasPages()): ?>
                        <div class="w-full"><?php echo e($prestasi->links()); ?></div>
                    <?php endif; ?>
                    
                    <a href="<?php echo e(route('public.prestasi.index')); ?>" class="inline-flex items-center justify-center gap-2 px-8 py-3 bg-slate-900 hover:bg-primary text-white font-bold rounded-xl transition-all shadow-md">
...
</section><?php /**PATH D:\prestasi-siswa\resources\views/pengunjung/home/partials/timeline.blade.php ENDPATH**/ ?>